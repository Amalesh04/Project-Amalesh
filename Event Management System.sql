...
('101', 'Yuvan Shankar', '2024-03-03', 'Chennai', 'Music Show'), 
('102', 'Story Teller', '2023-11-19', 'Bangalore', 'Exhibition'),
('103', 'Flimfare Awards', '2023-11-12', 'Delhi', 'Movie'),
('104', 'I was not Ready Da!', '2024-01-06', 'Bangalore', 'Comedy'),
('105', 'GOAT - Tamil', '2024-02-13', 'Kolkata', 'Movie');

SELECT * FROM Events;

INSERT INTO Attendees (Attendee_Id, Attendee_Name, Attendee_Phone, Attendee_Email, Attendee_City) VALUES 
('1001', 'Nirmal', '9999999991', 'nirmal@gmail.com', 'Delhi'),
('1002', 'Gokul', '9999999992', 'gokul@gmail.com', 'Delhi'),
('1003', 'Prithivi', '9999999993', 'prithivi@gmail.com', 'Mumbai'),
('1004', 'Vijay', '9999999994', 'vijay@gmail.com', 'Uttar Pradesh'),
('1005', 'Abhi', '9999999995', 'abhi@gmail.com', 'Mumbai'),
('1006', 'Maddy', '9999999996', 'maddy@gmail.com', 'Goa'),
('1007', 'Krishna', '9999999997', 'krishna@gmail.com', 'Uttrakhand'),
('1008', 'Abinesh', '9999999998', 'abinesh@gmail.com', 'Delhi');
...
-- Query to retrieve event information, generate attendee lists, and calculate event attendance statistics
WITH Event1 AS(
